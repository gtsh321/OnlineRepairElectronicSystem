...
<body style="background: linear-gradient(to right, rgb(198, 255, 221), rgb(251, 215, 134), rgb(247, 121, 125));">
    ...
    <nav>
        <ul>
            ...
            <li>
                <a href="technician.jsp"  class="active">Technician</a>
            </li>
            <li>
    ...
    <br><br><br>
     <div class="login" style="margin-top:100px;">
        <h2>Sign In</h2>
        <form action="techact.jsp" method="post">
        ...
        <br>
        <a href="techreg.jsp" style="color:black">New Technician Click Here....</a><br><br>
